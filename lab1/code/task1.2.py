...
def read_file():
    with open(r"C:\Users\Данила\PycharmProjects\DE_labs\lab1\data\second_task.txt", encoding="utf-8") as file:
...
def second_operation(column, maximum, minimum):
    with open(r"C:\Users\Данила\PycharmProjects\DE_labs\lab1\result\result1.2.txt", "w", encoding="utf-8") as file:
        for num in column:
            file.write(f"{num}\n")
        file.write(f"\n{maximum}\n{minimum}")
print('Результат записан в result1.2.txt')
