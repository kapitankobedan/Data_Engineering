...
with open(r"C:\Users\Данила\PycharmProjects\DE_labs\lab2\result\result2.1.1.json", "w", encoding="utf-8") as file:
    json.dump(matrix_props, file)
    print('Результат записан в result2.1.1.json')

norm_matrix = matrix / matrix_props['sum']
np.save(r"C:\Users\Данила\PycharmProjects\DE_labs\lab2\result\result2.1.2.npy", norm_matrix)
print('Результат записан в result2.1.2.json')

print(f"Сумма нормированной матрицы = {np.load(r"C:\Users\Данила\PycharmProjects\DE_labs\lab2\result\result2.1.2.npy").sum()}")